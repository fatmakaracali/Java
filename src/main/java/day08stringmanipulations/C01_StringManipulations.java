...
public class C01_StringManipulations {
  ...
  /*
       ...
       // boolean third = !mail.contains("[A-Z]");  // contains methodu Regex karakterlerle dogru
        // bir sekilde calismaz.Bu nedenle replaceAll() ya da replace ile silme yapip geriye kalanlarin lenght
        // ine bakilir
