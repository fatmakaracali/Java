...
*/
      ...
      public static void dogrucevapsayisi(char[][] answers, char[] keys) {
          ...
          for (int i = 0; i < answers.length; i++) {//0'dan ogrenci sayisi kadar dönguye aldik

              int sayac =0;

              for (int j = 0; j < answers[i].length; j++) { //0'dan ögrencinin cevap sayisina kadar dönguye aldik
                  if (answers[i][j]==keys[j]){  //ogrencinin cevabi, cevap anahtariyla esit mi kontrol ediyoruz
