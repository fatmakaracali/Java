...
public class DateTime01 {
    public static void main(String[] args) {
        ...
        System.out.println(myCurrentTime);    //20:04:14.123376200
        ...
        DateTimeFormatter dtf1= DateTimeFormatter.ofPattern("HH.mm");  //("hh:mm a")ifadesindeki bosluk a
        // 12'lik saat sisteminde "AM" , "PM" yazilmasini saglar
        ...
        DateTimeFormatter dtf7= DateTimeFormatter.ofPattern("MM/dd/yyyy");
        String formattedMyCurrentDate1 = dtf7.format(myCurrentDate);
