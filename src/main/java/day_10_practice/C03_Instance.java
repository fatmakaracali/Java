...
public class C03_Instance {
    ...
    int sayi;          // default degeri 0
    String bransIsmi="Java";
    boolean okuldaMi;  // default degeri false
    ...
    Bu instance variable'leri main icerisinde yazdıralım */
      ...
      //Instance variale'lara  static method'dan ulasabilmek icin obje olusturmamiz gerekir
        ...
        //instance variable'lar objeye baglidir.Hangi obje uzerinden variable'da degisiklik yapildiysa yapilan
        // bu degisiklik sadece o objeyi baglar
