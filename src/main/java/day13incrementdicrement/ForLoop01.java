...
public class ForLoop01 {
    ...
    public static void main(String[] args) {
        ...
        // 21'den 180'e kadar hem 4 hem de 6 ile bolunebilen tamsayilari ekrana yazdiran kodu yazini<
...
//             ankara ==> AKR
        ...
        for (int i = 0; i < s.length(); i++) {
            ...
            if (i % 2 == 0) {
                System.out.print(ch.toUpperCase());  //AKR
            }else{
                System.out.println(ch);            //AnKaRa
            }
